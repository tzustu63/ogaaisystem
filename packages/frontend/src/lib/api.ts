...
export const pdcaApi = {
  ...
  update: (id: string, data: any) => api.put(`/pdca/${id}`, data),
  delete: (id: string) => api.delete(`/pdca/${id}`),
  ...
  updateExecution: (executionId: string, data: any) => api.put(`/pdca/executions/${executionId}`, data),
  deleteExecution: (executionId: string) => api.delete(`/pdca/executions/${executionId}`),
  createCheck: (id: string, data: any) => api.post(`/pdca/${id}/checks`, data),
  updateCheck: (checkId: string, data: any) => api.put(`/pdca/checks/${checkId}`, data),
  deleteCheck: (checkId: string) => api.delete(`/pdca/checks/${checkId}`),
  createAction: (id: string, data: any) => api.post(`/pdca/${id}/actions`, data),
  updateAction: (actionId: string, data: any) => api.put(`/pdca/actions/${actionId}`, data),
  deleteAction: (actionId: string) => api.delete(`/pdca/actions/${actionId}`),
};
